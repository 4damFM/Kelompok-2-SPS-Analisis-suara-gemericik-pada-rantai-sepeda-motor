...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_title.setText("<h3 align='center'>Audio Recorder Detection for Noise gear</h3>")
        ...
        self.plot_data_time = self.plot_widget_time.plot(pen=pg.mkPen(color='yellow', width=2))  # Warna Time Domain
        self.plot_data_freq = self.plot_widget_freq.plot(pen=pg.mkPen(color='cyan', width=2))    # Warna DFT
...
# Tambahkan di dalam class Ui_MainWindow
    ...
    # Ambil data yang sudah direkam dan update grafik waktu dan frekuensi
        ...
        # Update grafik frekuensi (frequency domain)
